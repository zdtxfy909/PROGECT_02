...
public class Paging {
	...
	//4로 설정하면 한 페이지에 4개의 글이 보인다
	private int pagePerBlock = 3; //하나의 블록에 표시되는 페이지 갯수
	//아래 다음으로 넘어가는 [1(beginPage),2,3(endPage)]
	...
	public void setTotalPage() {
		totalPage = totalRecord / numPerPage; //전체데이터 갯수/페이지당 표시할 개수
